...
<html lang="en">
    ...
    <body>
        ...
        <div
            ...
            tabindex="-1"
            role="dialog"
            aria-labelledby="createPhoneModalLabel"
            aria-hidden="true"
        >
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createPhoneModalLabel">
                            Thêm phone mới
                        </h5>
                        <button
                            type="button"
                        ...
                        <form id="createPhoneForm">
                            <div class="form-group">
                                <label for="phoneNumbers">
                                    Nhập số điện thoại (mỗi dòng một số, tối đa
                                    500 dòng):
                                </label>
                                <textarea
                                    class="form-control"
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#createPhoneForm').on('submit', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (
                                data.data.invalid_phones &&
                                data.data.invalid_phones.length > 0
                            ) {
                                message +=
                                    '\n\nInvalid phones:\n' +
                ...
                $('#deleteSelected').on('click', function () {
                    ...
                    if (
                        confirm(
                            'Are you sure you want to delete the selected phones?',
                        )
                    ) {
                        $.ajax({
